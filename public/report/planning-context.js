const SCENARIOS = {
  preview: {
    ...
    sample: '学生目前已具备一定的先修基础，基础概念理解较快，但对 AP 课程中的英文术语、题干表达和知识迁移还需要提前适应。学习习惯方面，学生课堂配合度较好，能够跟随老师完成讲解和基础练习，但课后仍需要加强笔记整理和术语记忆。预习阶段建议先完成前几个 Unit 的基础学习，建立核心概念框架。课程安排上每周 2 节，每节 1.5 小时，预计完成 12 课次。作业以基础练习、笔记整理和术语记忆为主，每完成 2 个 Unit 后安排一次阶段测评。',
  },
  synchronous: {
    label: '同步',
